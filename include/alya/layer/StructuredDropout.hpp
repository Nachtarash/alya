...
/// @brief Art of normalization | creates a mask with values 0 and 1 and deactivates the Neuron in blocks of [outerDim, lastDim]
...
/// @note lastDim = dims / dims - 1, outerDim = size / lastdim
